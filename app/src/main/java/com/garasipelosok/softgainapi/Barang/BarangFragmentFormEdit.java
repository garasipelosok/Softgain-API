    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<SingleDataBarang>() {
            ...
            public void onResponse(Call<SingleDataBarang> call, Response<SingleDataBarang> response) {
                if(response.isSuccessful()){
                    ...
                    nomor_barang.setText(String.valueOf(response.body().getSuccess().getData().getNomorBarang()));
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Interface service = Client.getClient().create(Interface.class);
                Call<GetReponseSuccess> call = service.postBarangUpdate("Bearer "+token, nomor_barang.getText().toString(), nama_barang.getText().toString(), jumlah_barang.getText().toString(), keterangan.getText().toString(), editedIdBarang);
